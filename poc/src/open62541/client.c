...
static int mainFunc(int argc, char *argv[]) {
    ...
    UA_StatusCode retval = UA_Client_getEndpoints(client, endpoint,
    ...
    printf("UA_Client_connect ...\n");
    retval = UA_Client_connect(client, endpoint); 
    printf("UA_Client_connect ... end\n");
    ...
    *parent = UA_NODEID_NUMERIC(0, UA_NS0ID_OBJECTSFOLDER);
...
#ifdef UA_ENABLE_SUBSCRIPTIONS
    printf("UA_ENABLE_SUBSCRIPTIONS ...\n");
    ...
    for (int i = 0; i < 5; i++) {
        ...
        sleep_ms(1000);
        printf("UA_ENABLE_SUBSCRIPTIONS ... i=%d\n", i);
        fflush(stdout);
    }
#else
    printf("UA_ENABLE_SUBSCRIPTIONS ... skip\n");
    fflush(stdout);
#endif
#if 0
    /* Read attribute */
    ...
    for (int i = 0; i < 5; i++) {
        UA_Client_run_iterate(client, 1000);
        sleep_ms(1000);
        printf("Subscription removed ... i=%d\n", i);
        fflush(stdout);
    }
#endif

#if 0 // def UA_ENABLE_METHODCALLS
...
#if 0 // def UA_ENABLE_NODEMANAGEMENT
    /* Add new nodes*/
    /* New ReferenceType */
    UA_NodeId ref_id;
